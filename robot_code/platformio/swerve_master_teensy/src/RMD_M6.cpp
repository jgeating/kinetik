...
void RMD_M6::setPosition(float angle)
{
  m_msg.buf[0] = 0xA4; // Position control command 2
  m_msg.buf[1] = 0;

  uint16_t speedLimit = 360 * 18;
  int32_t ang_int = (int32_t)(angle * 100 * 18); // RMD-X6 takes angle over CAN as int32 in hundredths of degrees
